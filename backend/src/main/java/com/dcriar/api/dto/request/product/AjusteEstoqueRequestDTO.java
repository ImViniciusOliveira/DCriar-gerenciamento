...
public class AjusteEstoqueRequestDTO {
     ...
     */
    @Schema(description = "A quantidade a ser ajustada. Use um valor positivo para adicionar e um valor negativo para remover estoque.", example = "-5", requiredMode = Schema.RequiredMode.REQUIRED)
