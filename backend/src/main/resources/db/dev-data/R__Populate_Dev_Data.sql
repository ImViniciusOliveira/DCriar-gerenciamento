...
WITH vendas_seed (apelido, cidade, estado, pais, canal_nome, data_criacao) AS (
    VALUES
        ...
        ('Equipe Expo Norte (DEV)', 'Brasilia', 'Distrito Federal', 'Brasil', 'Equipe de Vendas', date_trunc('day', NOW()) - INTERVAL '1 day' + INTERVAL '9 hour'),
...
itens_seed (venda_apelido, produto_sku, quantidade, preco_original, preco_unitario, tipo_preco_aplicado, motivo_alteracao_preco) AS (
    VALUES
        ...
        ('Boutique da Lona (DEV)', 'FITA-DF-25MM', 12, 75.00, 73.00, 'PRECO_ALTERADO', 'Negociação de volume'),
        ('Ink Lab Centro (DEV)', 'PO-ADT-500G', 13, 79.90, 78.00, 'PRECO_ALTERADO', 'Condição para recompra'),
