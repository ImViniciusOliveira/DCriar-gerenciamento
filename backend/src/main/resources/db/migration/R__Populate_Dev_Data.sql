...
-- Note: A entidade MovimentacaoEstoqueLote não herda de AuditableEntity, então não precisa das colunas de data aqui.
...
INSERT INTO produtos (nome, sku, descricao, cor, unidades_por_produto, ativo, foto_principal_url, tipo_materia_prima_id, largura_cm, comprimento_cm, data_criacao, data_atualizacao) VALUES
    ('Cartão de Visita Premium', 'CV-PREM-9X5', 'Cartão de visita em papel couchê 300g, laminação fosca.', 'Branco', 100, true, '', 1, 9.0, 5.0, NOW(), NOW()),
    ('Banner Comercial 1,20x0,80m', 'BNR-COM-120X80', 'Banner em lona fosca 440g com bastão e corda.', 'Personalizada', 1, true, '', 2, 80.0, 120.0, NOW(), NOW()),
    ('Adesivo Redondo 5cm', 'ADSV-RD-5', 'Adesivo em vinil branco para uso geral, corte redondo.', 'Branco', 100, true, '', 3, 5.0, 5.0, NOW(), NOW()),
    ('Folder A4 (Dobrado)', 'FLD-A4-OLD', 'Folder promocional antigo. Produto descontinuado.', 'Colorido', 1, false, '', 1, 21.0, 29.7, NOW(), NOW()),
    ('Rótulo para Cerveja Long Neck', 'ROT-CERV-LN', 'Rótulo para garrafas, resistente à umidade, em BOPP transparente.', 'Transparente', 50, true, '', 4, 8.0, 7.0, NOW(), NOW()),
    ('Adesivo Holográfico (Novo)', 'ADSV-HOLO-10', 'Adesivo com efeito holográfico, corte especial.', 'Holográfico', 100, true, '', 3, 10.0, 10.0, NOW(), NOW()),
    ('Tag para Roupas Kraft', 'TAG-KFT-4X9', 'Tag de papel kraft 180g com furo.', 'Pardo', 100, true, '', 5, 4.0, 9.0, NOW(), NOW());

-- ETAPA F: ESTOQUE MESTRE INICIAL (COM VARIAÇÕES)
-- Note: A entidade MovimentacaoEstoqueProduto não herda de AuditableEntity.
...
-- Note: A entidade Estoque não herda de AuditableEntity.
