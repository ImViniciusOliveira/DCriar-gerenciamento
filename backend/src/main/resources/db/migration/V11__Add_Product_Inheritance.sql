...
-- 2. Adiciona as novas colunas que pertencem apenas a produtos de consumo direto.
...
-- Isso é necessário porque produtos de consumo direto não terão esses valores.
